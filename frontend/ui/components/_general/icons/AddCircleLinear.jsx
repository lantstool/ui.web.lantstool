export const AddCircleLinear = ({ style }) => (
  <svg
    className={style}
    width="16"
    height="16"
  ...
  >
    <g clipPath="url(#clip0_49_27535)">
      <path
        ...
        stroke="#868E96"
      />
      <path d="M10 8H8M8 8H6M8 8V6M8 8V10" stroke="#868E96" strokeLinecap="round" />
    </g>
    <defs>
      <clipPath id="clip0_49_27535">
        <rect className={style} width="16" height="16" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
